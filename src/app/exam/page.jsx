  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-12">
      <div className="w-full max-w-3xl mx-auto pt-8 px-4">
        ...
        {/* --- العنوان مع الخط المخصص --- */}
        <div className="flex flex-col items-center mb-10">
          <h2 className="text-4xl font-bold text-center mb-4" style={{ color: '#6367FF' }}>
            اختبار على المناعة
          </h2>
          {/* الخط أسفل الكلمة: w-64 يجعله أعرض، h-1.5 يحدد السمك، mb-2 للبعد */}
          <div 
            className="w-64 h-1.5 rounded-full shadow-sm" 
            style={{ backgroundColor: '#8494FF', opacity: 0.7 }}
          ></div>
        </div>
        {/* --------------------------- */}
        ...
        {showResult && (
          <div className="mb-8 p-6 bg-white border-2 border-green-200 rounded-2xl text-center shadow-md">
            <h3 className="text-2xl font-bold text-green-700 mb-2">نتيجتك هي: {score} من {questions.length}</h3>
            <p className="text-gray-600">راجع إجاباتك في الأسفل</p>
        ...
        <div className="space-y-8 bg-white p-8 rounded-2xl shadow-lg border border-gray-100 text-right" dir="rtl">
