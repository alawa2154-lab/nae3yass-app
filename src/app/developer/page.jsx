        ...
        <div className="px-8 pb-8 -mt-20 text-center relative z-10">
          ...
          <div className="flex justify-center gap-6">
            ...
            <a 
              ...
              className="group p-3 rounded-full text-white hover:scale-110 transition-all shadow-lg" 
            ...
            {/* WhatsApp - تم تحديث الرابط هنا */}
            <a 
              href="https://wa.me/qr/CBTBWVC5MAWHB1" 
              target="_blank" 
              rel="noopener noreferrer"
              className="group p-3 bg-green-500 rounded-full text-white hover:bg-green-600 hover:scale-110 transition-all shadow-lg"
            >
            ...
            {/* Gmail */}
            <a 
              href="mailto:alawa2154@gmail.com" 
              className="group p-3 bg-red-500 rounded-full text-white hover:bg-red-600 hover:scale-110 transition-all shadow-lg"
